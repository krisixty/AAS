...
<form action="apply_er.php" method="post" id="form1" target="_blank">
...
Hereby, I apply to:<br><br>
	...
	<fieldset> 
		...
		<legend>Person to notify in emergency:</legend>
			...
			<label for="er_add_pc">Postal Code: (If you don't have postal code write '-')</label>
	...
	<label for="mgname">Given name:</label>
	...
	<label for="about">I first learnt about the programs offered by the University of Szeged:</label>
